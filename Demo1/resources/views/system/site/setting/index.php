...
<link href="./plugins/bootstrap3-editable/inputs-ext/address/address.css" rel="stylesheet" />
        ...
        <div class="panel-body panel-form">
            <div id="form-main" class="form-horizontal form-bordered" >
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="text" data-original-title="網站標題">
                            鳩第辜德
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="text" data-original-title="電話">
                            04-1234-5555
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="text" data-original-title="傳真">
                            04-1234-5555
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" data-type="text" data-original-title="手機">
                            0986-123456
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="text" data-original-title="電子郵件">
                            r123456@gmail.com
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" data-type="text" data-original-title="LINE ID">
                            judy_test
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="text" data-original-title="地址">
                            420 台中市豐原區中陽東街68號
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="text" data-original-title="版權說明">
                            版權說明版權說明版權說明版權說明版權說明
                        </a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="text" data-original-title="網站關鍵字">
                            網站關鍵字, 網站關鍵字, 網站關鍵字
                        </a>
                    </div>
                </div>
        ...
        <div class="panel-body panel-form">
            <div id="form-sub" class="form-horizontal form-bordered">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a class="editable" href="javascript:;" data-type="select" data-name="maintenance.online" data-pk="1" data-value="1" data-original-title="網站狀態" style="color: rgb(0, 128, 0);">正常啟用</a>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label"><span class="required"></span> 維護說明內容<br/><a id="edit-repair-content"><i class="glyphicon glyphicon-pencil"></i> 修改</a></label>
                    <div class="col-md-9">
                        <div data-original-title="Enter notes" data-toggle="manual" data-name="maintenance.content" data-type="wysihtml5" data-pk="1" id="repair-content" class="editable" tabindex="-1">親愛的會員您好：<br>為了提升資料品質，目前正在進行資料維護，<br>預計於19:00結束，造成您的不便敬請見諒</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">IP白名單</label>
                    <div class="col-md-9">
                        <a href="javascript:;" data-type="select2" data-pk="1" data-original-title="Enter tags" class="editable editable-click">
                                                    </a>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="panel-body panel-form">
                <div id="form-tree" class="form-horizontal form-bordered">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <a class="editable" href="javascript:;" data-type="text" data-pk="1" data-value="http://www.judy.com/" data-original-title="網址">
                                http://www.judy.com/</a>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <a class="editable" href="javascript:;" data-type="text" data-pk="1" data-value="doctorzzang" data-original-title="帳號">
                                doctorzzang                            </a>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <a class="editable" href="javascript:;" data-type="text" data-pk="1" data-value="ekrxj!#%" data-original-title="密碼">
                                ekrxj!#%                            </a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $.getScript('./plugins/bootstrap3-editable/js/bootstrap-editable.min.js').done(function() {
