...
<script>
    ...
    $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap3-editable/js/bootstrap-editable.min.js').done(function() {
        $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap3-editable/inputs-ext/address/address.js').done(function() {
            $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap3-editable/inputs-ext/typeaheadjs/lib/typeahead.js').done(function() {
                $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap3-editable/inputs-ext/typeaheadjs/typeaheadjs.js').done(function() {
                    $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap3-editable/inputs-ext/wysihtml5/wysihtml5.js').done(function() {
                        $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap-wysihtml5/lib/js/wysihtml5-0.3.0.js').done(function() {
                            $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap-wysihtml5/src/bootstrap-wysihtml5.js').done(function() {
                                $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js').done(function() {
                                    $.getScript('http://kr8851.com/assets/sumi/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js').done(function() {
                                        $.getScript('http://kr8851.com/assets/sumi/plugins/select2/select2.min.js').done(function() {
                                            $.getScript('http://kr8851.com/assets/sumi/plugins/mockjax/jquery.mockjax.js').done(function() {
                                                $.getScript('http://kr8851.com/assets/sumi/plugins/moment/moment.min.js').done(function() {
...
//
                                                    ...
                                                    form.find('#repair-content').editable({
                                                        placement: 'left',
                                                        url: '/sumi/site/setting/update'
                                                    });
