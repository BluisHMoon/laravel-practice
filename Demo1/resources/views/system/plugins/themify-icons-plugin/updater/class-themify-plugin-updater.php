	...
	function check_version() {
		...
		if ( is_object( $newUpdate ) && $time_not_changed ) {
			if ( version_compare( $version, $newUpdate->version, '<') ) {
				$notifications .= sprintf( __('<p class="update">%s version %s is now available. <a href="%s" class="%s">Update now</a> or view the <a href="https://themify.me/changelogs/%s.txt" class="themify-changelogs" target="_blank" data-changelog="http://themify.me/changelogs/%s.txt">change log</a> for details.</p>', 'themify'),
